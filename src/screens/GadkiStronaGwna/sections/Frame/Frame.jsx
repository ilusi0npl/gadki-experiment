...
export const Frame = () => {
  return (
    <div className="flex flex-col w-[655px] items-center gap-12 absolute top-[1750px] left-[536px]">
      <div className="relative w-[180px] h-[180px] bg-beige-400 rounded-[20000px] overflow-hidden aspect-[1]">
        <img
      ...
      <div className="flex flex-col w-[480px] items-start gap-10 relative flex-[0_0_auto]">
        <p className="relative self-stretch mt-[-1.00px] [font-family:'Lato',Helvetica] font-semibold text-fddsraspberry text-2xl text-center tracking-[-0.26px] leading-9">
          Gadki to rozmowy na temat kilku prostych zasad, które pomogą ochronić
          Twoje dziecko przed wykorzystywaniem seksualnym.
        </p>

        <p className="relative self-stretch [font-family:'Lato',Helvetica] font-normal text-black text-2xl text-center tracking-[-0.26px] leading-9">
