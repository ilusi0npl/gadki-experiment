...
export const GadkiStronaGwna = () => {
  return (
    ...
    >
      <Footer />
      <img
        className="absolute top-[2950px] left-0 w-[1728px] h-[1352px]"
        alt="Union"
      ...
      <img
        className="absolute w-[102.47%] h-0 top-[11.53%] left-[46.39%]"
        alt="Vector"
        src="/img/vector.png"
      />

      <img
        className="absolute w-[101.24%] h-[12.30%] top-0 left-0"
        alt="Union"
