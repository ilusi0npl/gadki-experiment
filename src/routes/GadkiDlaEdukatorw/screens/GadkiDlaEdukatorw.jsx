...
export const GadkiDlaEdukatorw = () => {
  return (
    <div className="bg-beige-200 overflow-hidden w-full min-w-[1728px] h-[11122px] relative">
      ...
      <div className="absolute inset-0 w-screen pointer-events-none">
        ...
        <img
          className="absolute top-[9591px] left-0 w-screen h-[723px] object-cover"
          alt="Union"
        ...
        <img
          className="absolute top-[9986px] left-0 w-screen h-[723px] object-cover"
          alt="Union"
      ...
      <div className="max-w-[1728px] mx-auto relative h-full">
        ...
        <footer className="absolute left-0 bottom-0 w-[1728px] h-[485px] flex items-center justify-center bg-beige-100">
          <div className="mt-[119.4px] h-[206.43px] ml-[-34px] w-[1146px] relative">
            ...
            <div className="flex flex-col w-[178px] items-start gap-2.5 absolute top-1.5 left-[600px]">
              <div className="relative self-stretch mt-[-1.00px] [font-family:'Lato',Helvetica] font-medium text-fddsraspberry text-base tracking-[-0.18px] leading-6">
                Dla dzieci
              </div>
        ...
        <div className="absolute top-[329px] left-[457px] [font-family:'Happy_Season-Bold',Helvetica] font-bold text-white text-8xl text-center tracking-[-1.06px] leading-[105.6px] whitespace-nowrap">
        ...
        <div className="flex flex-col w-[1172px] items-center gap-12 absolute top-[6046px] left-[274px]">
          <div className="relative self-stretch mt-[-1.00px] [font-family:'Happy_Season-Semibold',Helvetica] font-normal text-fddsraspberry text-8xl text-center tracking-[-1.06px] leading-[105.6px]">
            Dodatkowe
            <br />
            materiały
          </div>
        ...
        <p className="absolute top-[6323px] left-[560px] w-[580px] [font-family:'Lato',Helvetica] font-normal text-black text-2xl text-center tracking-[-0.26px] leading-9">
        ...
        <div className="flex w-[280px] items-center justify-center gap-2.5 px-6 py-5 absolute top-[6491px] left-[874px] rounded-[48px] border-2 border-solid border-[#e83f4b]">
          <div className="relative w-fit mt-[-2.00px] [font-family:'Lato',Helvetica] font-bold text-fddsraspberry text-2xl tracking-[-0.26px] leading-9 whitespace-nowrap">
            Zarejestruj się
          </div>
        </div>
        ...
        <p className="absolute top-[7117px] left-[874px] w-[480px] [font-family:'Lato',Helvetica] font-normal text-black text-2xl tracking-[-0.26px] leading-9">
        ...
        <p className="top-[6789px] left-[374px] absolute w-[480px] [font-family:'Lato',Helvetica] font-normal text-black text-2xl tracking-[-0.26px] leading-9">
          Curabitur feugiat, augue a sollicitudin semper, sem turpis euismod
          purus, sit amet volutpat turpis augue non diam. Class aptent taciti
          sociosqu ad litora torquent per conubia nostra.
        </p>

        <p className="top-[7606px] left-[874px] absolute w-[480px] [font-family:'Lato',Helvetica] font-normal text-black text-2xl tracking-[-0.26px] leading-9">
          Curabitur feugiat, augue a sollicitudin semper, sem turpis euismod
          purus, sit amet volutpat turpis augue non diam. Class aptent taciti
          sociosqu ad litora torquent per conubia nostra.
        </p>
        ...
        <div className="absolute top-[9008px] left-[278px] w-[1172px] [font-family:'Happy_Season-Semibold',Helvetica] font-normal text-fddsraspberry text-8xl text-center tracking-[-1.06px] leading-[105.6px]">
          Pozostałe
          <br />
          materiały
        </div>
