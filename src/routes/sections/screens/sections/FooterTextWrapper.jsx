...
export const FooterTextWrapper = () => {
  return (
    <div className="absolute left-[calc(50.00%_-_864px)] bottom-px w-[1728px] h-[486px] flex items-center justify-center bg-beige-100">
      <div className="mt-[118.4px] h-[206.43px] ml-[-34px] w-[1146px] relative">
        <img
        ...
        <img
          ...
          alt="Frame"
          src="https://c.animaapp.com/mhyuvh6ynrLTWn/img/frame-27-1.svg"
        />
      </div>
    </div>
  );
