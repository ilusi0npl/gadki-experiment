...
export const GadkiDlaDzieci46 = () => {
  ...
  useEffect(() => {
    document.title = "Dla dzieci 4-6 lat - GADKI";
  }, []);
  ...
  return (
    <div className="bg-beige-200 overflow-hidden w-full h-[8970px] relative">
      ...
      <div ref={ageTabs.ref} className={`inline-flex items-center gap-[120px] absolute top-[486px] left-[calc(50.00%_-_390px)] ${ageTabs.className}`}>
        <Link to="/dla-dzieci/4-6" className="relative w-[180px] mt-[-1.00px] font-happy-season font-bold text-white text-[64px] text-center tracking-[-0.70px] leading-[70.4px] hover:opacity-80 transition-opacity">
          4–6 lat
        </Link>
      ...
      <div ref={videoFrame.ref} className={`absolute top-[644px] left-[274px] w-[1180px] h-[622px] ${videoFrame.className}`}>
        <iframe
          ...
          title="GADKI - Program dla dzieci 4-6 lat"
          frameBorder="0"
